 ...
 <section>
 	<div class="row-fluid">
      <div class="span8 offset3">
         ...
         <p><strong>1. </strong>All fields Must Be Filled Up.</p>
         <p><strong>2. </strong>You Can Set Total Questions & You Have Options To Show Limitated Questions For Exam.</p>
         <p><strong>3. </strong>You Can Set Up How Long Exam Should Be Running Through Setting The Exam Running Time.</p>
         <p><strong>4. </strong>Exam Running Time & Time Per Question Count Are In Minutes & Seconds Respectively.</p>
         <p><strong>5. </strong>Starting Time Format Must Be [YYYY-MM-DD hh:mm:ss] & Time Is 24 Hour Format, If These Conditions Are Not True,Exam System Will Not Work For You.</p>
      </div>
    </div>
 </section>
      ...
      <div class="span8 offset3">
		<form action="" method="POST">
		  ...
		  <div class="form-group hgad">
		    ...
		    <input type="number" class="form-control adgrfs" name="examRunningTime" placeholder="Minutes For Exam" required="1">
		  </div>
		  <div class="form-group hgad">
		    <label style="margin-right: 22px;">Time Per Question: </label>
		    <input type="number" class="form-control adgrfs" name="eachQuestionTime" placeholder="Seconds Per Question" required="1">
		  </div>
		  <div class="form-group hgad">
