     ...
     <div class="span8 offset3">
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group hgad">
            ...
            <input type="text" class="form-control adgrfs" name="tfcs" placeholder="Should Be Same As The Any Of The Option Mentioned. Otherwise It Will Not Work." required="1">
          </div>
