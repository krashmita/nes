    ...
    <div class="row-fluid">
      <div class="span11 offset1">
        <div class="alert alert-success" style="font-size: 16px;">
		  <strong>Successful!!</strong> <span>Your Exam Is Completed Successfully. Please Go Back To The Dashboard.</span>
		</div>
		<div class="alert alert-warning">
		<h2 style="text-align: justify;">To see your Examination results Please contact your Administrator. When your Administrator publish your results, Then only You can see your results. Otherwise Result will not be visible.</h2>
		</div>
