 ...
 <section>
 	<div class="row-fluid">
      <div class="span8 offset3">
         ...
         <p><strong>2. </strong>You Can Set Total Question & You Have Option To Show Limitated Question For Exam.</p>
         <p><strong>3. </strong>You Can Set Up, How Long Exam Should Be Running Through Setting The Exam Running Time.</p>
         <p><strong>4. </strong>Exam Running Time & Time Per Question Count Is In Minutes & Seconds Time Format Respectively</p>
         <p><strong>5. </strong>Starting Time Format Must Be [YYYY-MM-DD hh:mm:ss] & Time Is 24 Hour Format, If These Conditions Are Not True, Then Exam System Will Not Work For You.</p>
      </div>
    </div>
 </section>
      ...
      ?>
		<form action="" method="POST">
		  ...
		  <div class="form-group hgad">
		    ...
		    <input type="number" class="form-control adgrfs" name="eachQuestionTime" placeholder="Minutes For Per Question" required="1" value="<?php echo $value['eachQuestionTime'];?>">
		  </div>
		  <div class="form-group hgad">
