  ...
  <div class="featured-content">
    <div class="row-fluid">
     ...
     <?php
        ...
        <h2>Some Information : </h2>
         ...
         <p>4. Total Questions: <strong><?php echo $value['totalExamShowQues']; ?></strong></p>
         <?php
        ...
        <h2>Some Rules : </h2>
        <p class="hgad"><strong>1. If you reload your current url or move back to your previous questions, then You will be suspended & You are no longer able to give this examination.</strong></p>
        <p><strong>2. After starting of your exam, If you go back to the exam starting page, Then you will be suspended.</strong></p>
     </div>
    </div>
     <?php 
     $ecv='';
    ...
    <div class="row-fluid">
     <div class="span8 offset2 text-center">
      ...
      <?php  } else{?>
          <button class="btn btn-primary esb">Exam Is Not Started</button></a>
       <?php } ?>
     </div>
    </div>
  </div>
