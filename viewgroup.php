...
<?php 
 if(!isset($_GET['vgid']) && $_GET['vgid']==NULL){
     ...
     $nt = new DateTime('now', new DateTimeZone('Asia/kolkata'));
   ...
   <section>
    <div class="row-fluid">
      <div class="span8 offset1 fn">
        ...
        <p>4. <strong>Time For Each Question: </strong><span style="color:#F76E5D;font-weight: bold"><?php echo $value['eachQuestionTime'];?> Seconds</p></span>
        ...
        <h2>Some Notes</h2>
        <div class = "vgn">
        <p>1. If your "Set Questions For Exam" is not greater or equal to the "Total Added Questions", User can't participate in the exam.</p>
        <p>2. You Can't Edit or Add Questions for your group when exam is running or exam is finished.</p>
        <p>3. When you publish the exam results, then only user can see the results. </p>
        </div>
      </div>
    </div>
    </section>
        ...
        <h3 style="width:500px;"><pre>User Information For This Group:</pre></h3><br>
          <table class="table table-bordered table-striped">
            ...
            <tr class="info">
              ...
              <td><a href="adminresultsheet.php?resid=<?php echo $eachsid;?>&regpid=<?php echo $vgid;?>&tgtq=<?php echo $tgtq;?>"><button class="btn btn-primary">See Results</button></a></td>
            </tr>
            <?php } } ?>
            </tbody>             
          </table>
    ...
    <section>
     <div class="row-fluid">
      <div class="span10 offset1 ">
        <h3 style="width: 300px;"><pre>Publish The Results:</pre></h3><br>
         <?php
            if($ch==""){
              echo "<button class='btn btn-primary offset5'>Wait For Finishing Exam</button>";
            }else{ ?>
              <a href="publishresult.php?pgid=<?php echo $vgid; ?>"><button class='btn btn-primary offset5'>Publish Results</button></a>
           <?php }
         ?>
       </div>
      </div>
